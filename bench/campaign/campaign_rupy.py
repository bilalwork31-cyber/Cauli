"""rupy stack wrapper, per PROTOCOL.md section 6.
...
RUPY_VARIANT env (read by dispatch AT CALL TIME inside the worker) selects
...
def dispatch(campaign_id):
    ...
    variant = os.environ.get("RUPY_VARIANT", "sync")
